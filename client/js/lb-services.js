  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Person#sendCoord
         * @methodOf lbServices.Person
         *
         * @description
         *
         ...
         */
        "sendCoord": {
          url: urlBase + "/people/sendCoord",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Person#greet
         * @methodOf lbServices.Person
         *
         * @description
         *
         ...
         */
        "greet": {
          url: urlBase + "/people/greet",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Person#getLastRoomMsgs
         * @methodOf lbServices.Person
         *
         * @description
         *
         ...
         */
        "getLastRoomMsgs": {
          url: urlBase + "/people/getLastRoomMsgs",
          method: "POST"
        },
...
/**
 * @ngdoc object
 * @name lbServices.Requeriment
 * @header lbServices.Requeriment
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Requeriment` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/requeriments/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.Requeriment#create
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Requeriment` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/requeriments",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Requeriment#createMany
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Requeriment#upsert
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Requeriment#exists
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/requeriments/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Requeriment#findById
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/requeriments/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Requeriment#find
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Requeriment#findOne
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/requeriments/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Requeriment#updateAll
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/requeriments/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Requeriment#deleteById
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Requeriment#count
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/requeriments/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Requeriment#prototype$updateAttributes
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Requeriment#createChangeStream
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/requeriments/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Requeriment#updateOrCreate
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Requeriment#update
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Requeriment#destroyById
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Requeriment#removeById
         * @methodOf lbServices.Requeriment
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Requeriment#modelName
    * @propertyOf lbServices.Requeriment
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Requeriment`.
    */
    R.modelName = "Requeriment";
